...
// Get the sorting parameter from the query string, if provided
...
// Modify the properties query to include sorting logic
if ($sort_order === "highest_rent") {
    $sql_2 = "SELECT * FROM properties WHERE city_id = $city_id ORDER BY rent DESC";
} elseif ($sort_order === "lowest_rent") {
...
<body>
    ...
    <div class="page-container">
        <div class="filter-bar row justify-content-around">
            ...
            <div class="col-auto">
                <a href="?city=<?php echo $city_name; ?>&sort=highest_rent">
                    <img src="img/desc.png" alt="sort-desc" />
                    <span>Highest rent first</span>
                </a>
            </div>
            <div class="col-auto">
                <a href="?city=<?php echo $city_name; ?>&sort=lowest_rent">
